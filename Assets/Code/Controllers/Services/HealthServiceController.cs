...
namespace Controllers.Services
{
    public class HealthServiceController
    {
        ...
        public void Damage(GameObject gameObject, int damage)
        {
            ...
            if(_healthDictionary.TryGetValue(gameObject, out var healthController)) healthController.Damage(damage);
        ...
        public void Heal(GameObject gameObject, int health)
        {
            ...
            if (_healthDictionary.TryGetValue(gameObject, out var healthController)) healthController.Heal(health);
        ...
        public void Resurect(GameObject gameObject)
        {
            ...
            if (_healthDictionary.TryGetValue(gameObject, out var healthController)) healthController.Resurect();
